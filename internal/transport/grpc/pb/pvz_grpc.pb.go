...
const (
	PVZService_GetPVZList_FullMethodName = "/pvz.PVZService/GetPVZList"
)
...
func (UnimplementedPVZServiceServer) GetPVZList(context.Context, *GetPVZListRequest) (*GetPVZListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPVZList not implemented")
}
...
func RegisterPVZServiceServer(s grpc.ServiceRegistrar, srv PVZServiceServer) {
	// If the following call panics, it indicates UnimplementedPVZServiceServer was
